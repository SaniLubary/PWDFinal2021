              ...
              <tbody>
                ...
                ?>
                  <tr id="tr-<?=$id?>">
                    ...
                    <td><input readonly name="comprador" id="<?=$id?>comprador" class="form-control" type="text" value="<?= $comprador ?>"></td>
                    <td><input readonly name="estado" id="<?=$id?>estado" class="form-control" type="text" value="<?= $estado ?>"></td>
                    <td>
                      <!-- Acciones  -->
                      <button class="btn btn-success" onclick="aumentarEstadoDeCompra(<?=$id?>)">
                        Aumentar Estado
                      </button>
                      <button class="btn btn-danger" onclick="cancelarCompra(<?=$id?>)">
                      <i class="bi bi-x-lg"></i> Cancelar Compra
                      </button>
                    </td>
                  </tr>
                <!-- CIERRE PHP FOREACH -->
